...
export class IntencaoPagamentoGateway {
  constructor(
    private readonly intencaoPagamentoRepository: IIntencaoPagamentoRepository,
  ) {}

  async salvarIntencaoPagamento(
    salvarIntencaoPagamento: IntencaoPagamento,
  ): Promise<IntencaoPagamento> {
    return await this.intencaoPagamentoRepository.salvarPagamento(
      salvarIntencaoPagamento,
    );
  }

  async buscarPorIdIntencaoPagamento(
    id: string,
  ): Promise<IntencaoPagamento | null> {
  ...
  async atualizarStatusIntencaoPagamento(
    ...
    return await this.intencaoPagamentoRepository.atualizarStatusPagamento(
      id,
